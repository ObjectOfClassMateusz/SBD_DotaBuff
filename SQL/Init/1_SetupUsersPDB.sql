...
CREATE USER mateusz_developer IDENTIFIED BY mateusz_haslo DEFAULT TABLESPACE mateusz_tablespace QUOTA UNLIMITED ON mateusz_tablespace;
...
CREATE USER dominik_developer IDENTIFIED BY dominik_haslo DEFAULT TABLESPACE dominik_tablespace QUOTA UNLIMITED ON dominik_tablespace;
